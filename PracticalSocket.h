...
// Edited by Qusay Mahmoud: dynamic exception specifications are deprecated since C++11, so the SocketException
// class is being commented out, along with all throw exceptions.
/*
